<?php $__env->startSection('title', 'Panel Karyawan'); ?>
                    ...
                    <!-- <table class="table table-responsive"> -->
                        <form action="/home" method="post">
                            ...
                            <button type="submit" class="btn btn-flat btn-primary  <?php echo e($info['btnOutstts']); ?>" name="btnOut" value="b" <?php echo e($info['btnOut']); ?>>ABSEN KELUAR</button>
                             <button type="submit" class="btn btn-flat btn-primary  <?php echo e($info['btnlembur']); ?>" name="btnlembur" value="c">Lebur</button>
                        </form>
