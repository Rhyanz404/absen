...
<!--                     <?php if(session('status')): ?>
                    ...
                    <!-- <table class="table table-responsive"> -->
                        <form action="/absen" method="post">
                            ...
                            <button type="submit" class="btn btn-flat btn-primary" name="btnIn" value="a" <?php echo e($info['btnIn']); ?> >ABSEN MASUK</button>
                            <button type="submit" class="btn btn-flat btn-primary" name="btnOut" value="b" <?php echo e($info['btnOut']); ?>>ABSEN KELUAR</button>
                        </form>
                    <!-- </table> -->
                </div>
            </div>
