...
@section('title', 'Mendaftar Karyawan')
@section('konten')
		<div class="col-md-9">
			...
			<form class="container" id="needs-validation" novalidate>
			  ...
			  <div class="row">
			    ...
			    <div class="col-md-3 mb-3">
			      ...
			      <input type="password" class="form-control" id="password-confirm" placeholder="First name" value="Mark" name="password_confirmation" required>
			    </div>
